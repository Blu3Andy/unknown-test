...
$EMAIL_NAME = "^"; /* the '^' is an important security feature! */
...
$EMAIL_ADDRS = array('team' => 'info@quins.de');

/* Help: http://www.tectite.com/fmdoc/def_alert.php */
$DEF_ALERT = "raphael@formatzwei.de";
...
$FROM_USER = "website@quins.de"; /* the default - setting not used */
...
$TEMPLATEDIR = "https://quins.de/en/static/"; /* directory for template files; empty string if you don't have any templates */
...
$ATTACK_DETECTION_DUPS = array("textfeld1","textfeld2","textfeld3");
...
$ATTACK_DETECTION_REVERSE_CAPTCHA = array("forname1"=>"q7ga","forname2"=>"");
